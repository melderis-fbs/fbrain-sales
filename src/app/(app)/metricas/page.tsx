...
export default async function Metricas({ searchParams }: { searchParams: Busqueda }) {
  ...
  const COMPARABLES: { etiqueta: string; ahora: number | null; antes: number | null
    ...
    { etiqueta: 'Cierres de reuniones de este período', ahora: m.ventas, antes: p.ventas,
      como: 'De las reuniones de este período, cuántas terminaron en venta. NO es el numerador del % de cierre —ése son los cierres firmados en el período—: va acá como dato de la cohorte.' },
